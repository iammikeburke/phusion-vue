...
/******/ 	return __webpack_require__(__webpack_require__.s = "./exports/build/TemplatesTask.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./exports/build/TemplatesTask.ts":
/*!****************************************!*\
  !*** ./exports/build/TemplatesTask.ts ***!
  \****************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var TemplatesTask_1 = __webpack_require__(/*! ../../src/build/task/TemplatesTask */ "./src/build/task/TemplatesTask.ts");
module.exports = TemplatesTask_1.TemplatesTask;
...
/***/ "./node_modules/phusion/src/build/module/AbstractModule.ts":
/*!*****************************************************************!*\
  !*** ./node_modules/phusion/src/build/module/AbstractModule.ts ***!
  \*****************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/phusion/src/build/module/Config/ConfigModule.ts":
/*!**********************************************************************!*\
  !*** ./node_modules/phusion/src/build/module/Config/ConfigModule.ts ***!
  \**********************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var AbstractModule_1 = __webpack_require__(/*! ../AbstractModule */ "./node_modules/phusion/src/build/module/AbstractModule.ts");
var Config_1 = __webpack_require__(/*! ./Entity/Config */ "./node_modules/phusion/src/build/module/Config/Entity/Config.ts");
var DefaultMergeHandler_1 = __webpack_require__(/*! ./MergeHandler/Default/DefaultMergeHandler */ "./node_modules/phusion/src/build/module/Config/MergeHandler/Default/DefaultMergeHandler.ts");
var EnvironmentMergeHandler_1 = __webpack_require__(/*! ./MergeHandler/Environment/EnvironmentMergeHandler */ "./node_modules/phusion/src/build/module/Config/MergeHandler/Environment/EnvironmentMergeHandler.ts");
...
/***/ "./node_modules/phusion/src/build/module/Config/Entity/Config.ts":
/*!***********************************************************************!*\
  !*** ./node_modules/phusion/src/build/module/Config/Entity/Config.ts ***!
  \***********************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/phusion/src/build/module/Config/MergeHandler/AbstractMergeHandler.ts":
/*!*******************************************************************************************!*\
  !*** ./node_modules/phusion/src/build/module/Config/MergeHandler/AbstractMergeHandler.ts ***!
  \*******************************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/phusion/src/build/module/Config/MergeHandler/Default/DefaultMergeHandler.ts":
/*!**************************************************************************************************!*\
  !*** ./node_modules/phusion/src/build/module/Config/MergeHandler/Default/DefaultMergeHandler.ts ***!
  \**************************************************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var AbstractMergeHandler_1 = __webpack_require__(/*! ../AbstractMergeHandler */ "./node_modules/phusion/src/build/module/Config/MergeHandler/AbstractMergeHandler.ts");
...
/***/ "./node_modules/phusion/src/build/module/Config/MergeHandler/Environment/EnvironmentMergeHandler.ts":
/*!**********************************************************************************************************!*\
  !*** ./node_modules/phusion/src/build/module/Config/MergeHandler/Environment/EnvironmentMergeHandler.ts ***!
  \**********************************************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/phusion/src/build/module/FileSystem/FileSystemModule.ts":
/*!******************************************************************************!*\
  !*** ./node_modules/phusion/src/build/module/FileSystem/FileSystemModule.ts ***!
  \******************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/phusion/src/build/module/Log/LogModule.ts":
/*!****************************************************************!*\
  !*** ./node_modules/phusion/src/build/module/Log/LogModule.ts ***!
  \****************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/phusion/src/build/module/ModuleContainer.ts":
/*!******************************************************************!*\
  !*** ./node_modules/phusion/src/build/module/ModuleContainer.ts ***!
  \******************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var ConfigModule_1 = __webpack_require__(/*! ./Config/ConfigModule */ "./node_modules/phusion/src/build/module/Config/ConfigModule.ts");
var FileSystemModule_1 = __webpack_require__(/*! ./FileSystem/FileSystemModule */ "./node_modules/phusion/src/build/module/FileSystem/FileSystemModule.ts");
var LogModule_1 = __webpack_require__(/*! ./Log/LogModule */ "./node_modules/phusion/src/build/module/Log/LogModule.ts");
...
/***/ "./node_modules/phusion/src/build/task/AbstractTask.ts":
/*!*************************************************************!*\
  !*** ./node_modules/phusion/src/build/task/AbstractTask.ts ***!
  \*************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var ModuleContainer_1 = __webpack_require__(/*! ../module/ModuleContainer */ "./node_modules/phusion/src/build/module/ModuleContainer.ts");
...
/***/ "./src/build/module/Autoload/AutoloadModule.ts":
/*!*****************************************************!*\
  !*** ./src/build/module/Autoload/AutoloadModule.ts ***!
  \*****************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var AbstractModule_1 = __webpack_require__(/*! phusion/src/build/module/AbstractModule */ "./node_modules/phusion/src/build/module/AbstractModule.ts");
var Config_1 = __webpack_require__(/*! phusion/src/build/module/Config/Entity/Config */ "./node_modules/phusion/src/build/module/Config/Entity/Config.ts");
var AutoloadModule = /** @class */ (function (_super) {
    __extends(AutoloadModule, _super);
    ...
    AutoloadModule.prototype.generateClassmap = function (projectRootDirPath, outputFilePath, groups, ignorePatterns) {
        ...
        var filesScanned = fileSystemModule.forEachFileRecursively(projectRootDirPath, function (fileName, absoluteFilePath) {
            ...
            for (var groupName in groups) {
                var groupRegex = groups[groupName];
                var regExp = new RegExp(groupRegex);
                // If the file name matches the regex
                if (regExp.test(fileName)) {
                    // Build relative file path
                    var rootPathPlaceholder = '{src}';
                    // Replace everything up to the project root with a placeholder
                    var pathFromProjectRoot = absoluteFilePath.replace(projectRootDirPath, rootPathPlaceholder);
        ...
        fileSystemModule.writeFile(outputFilePath, '');
        // Stringify classmap
        var classmapString = JSON.stringify(classmap, null, 2);
         ...
         */
        var classPathMapOutputFilePath = outputFilePath.replace(/\/[^/]+\.[^\.]+$/, '/pathmap.js');
        // Stringify classmap
        var pathMapString = JSON.stringify(classPathMap, null, 2);
    ...
    AutoloadModule.prototype.getImportStatementBlock = function (classPathMap, projectRootAbsolutePath, importFromDirPath) {
        ...
        var importStatementBlock = "";
        var fileSystemModule = this.getModuleContainer().getFileSystemModule();
        // How to get from project root from importDirPath
        var srcReplacement = fileSystemModule.getRelativePathBetweenDirs(importFromDirPath, projectRootAbsolutePath);
        var classesAddedToImportBlock = [];
        for (var groupName in classPathMap) {
            // Comment for the group
            importStatementBlock += "\n// " + groupName + "\n";
            // Get all classes in this group
            var groupClassmap = classPathMap[groupName];
            // For each class in the group
            for (var className in groupClassmap)
                if (groupClassmap.hasOwnProperty(className)) {
                    ...
                    var relativePathFromRoot = groupClassmap[className];
                    var importPath = relativePathFromRoot
                        // Replace {src} placeholder
                        .replace('{src}', srcReplacement)
                        // Remove file extension
                        .replace(/\.[^.]+$/, '');
                    var importStatement = importStatementTemplate;
    ...
    AutoloadModule.prototype.removeQuotesFromClassNames = function (classmap, jsonString) {
        // Remove quotes around class names
        var classNamesToBeReplaced = [];
        // For each key in the classmap
        for (var groupName in classmap) {
            if (classmap.hasOwnProperty(groupName)) {
                // Get an array of file path maps for all classes under this key
                var group = classmap[groupName];
                // Get array of class names
                var classes = Object.keys(group);
        ...
        for (var _i = 0, classNamesToBeReplaced_1 = classNamesToBeReplaced; _i < classNamesToBeReplaced_1.length; _i++) {
            var classNameToReplace = classNamesToBeReplaced_1[_i];
            // Run a string replace on the jsonString to remove any instances surrounded by quotes
            var regexPatternToReplace = new RegExp('\"' + classNameToReplace + '\"', 'g');
...
Object.defineProperty(exports, "__esModule", { value: true });
var ModuleContainer_1 = __webpack_require__(/*! phusion/src/build/module/ModuleContainer */ "./node_modules/phusion/src/build/module/ModuleContainer.ts");
var AutoloadModule_1 = __webpack_require__(/*! ./Autoload/AutoloadModule */ "./src/build/module/Autoload/AutoloadModule.ts");
var ModuleContainer = /** @class */ (function (_super) {
    __extends(ModuleContainer, _super);
    function ModuleContainer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ModuleContainer.prototype.getAutoloadModule = function () {
        if (!this.autoloadModule) {
            this.autoloadModule = new AutoloadModule_1.AutoloadModule(this);
        }
        return this.autoloadModule;
    };
    return ModuleContainer;
}(ModuleContainer_1.ModuleContainer));
exports.ModuleContainer = ModuleContainer;


/***/ }),

/***/ "./src/build/task/TemplatesTask.ts":
/*!*****************************************!*\
  !*** ./src/build/task/TemplatesTask.ts ***!
  \*****************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var AbstractTask_1 = __webpack_require__(/*! phusion/src/build/task/AbstractTask */ "./node_modules/phusion/src/build/task/AbstractTask.ts");
var ModuleContainer_1 = __webpack_require__(/*! ../module/ModuleContainer */ "./src/build/module/ModuleContainer.ts");
var TemplatesTask = /** @class */ (function (_super) {
    __extends(TemplatesTask, _super);
    function TemplatesTask() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.queueLimit = 1;
        return _this;
    }
    TemplatesTask.prototype.exec = function () {
        ...
        var classmapGroup = taskConfig.getByPath('classmapGroup');
        // Init view cache
        var viewCache = {};
        // Get path map file path from class map path
        var pathMapFilePath = classmapFilePath.replace(/\/[^/]+\.[^\.]+$/, '/pathmap.js');
        // Import pathmap
        var pathMap = null;
        try {
        ...
        var groupPathMap = pathMap[classmapGroup];
        ...
        for (var className in groupPathMap) {
            var classFilePath = groupPathMap[className];
            // Build file path to the view
            var componentBaseName = className.replace(/Component$/, '');
            var viewFilePath = classFilePath.replace(/\/[^\/]+$/, '/View/' + componentBaseName + '.html');
        ...
        var jsonString = JSON.stringify(viewCache, null, 2);
        var fileContents = '\nmodule.exports = ' + jsonString + ';\n';
        fileSystemModule.writeFile(outputFilePath, fileContents);
    };
    TemplatesTask.prototype.getRequiredTaskConfigPaths = function () {
        return {
    ...
    TemplatesTask.prototype.getDefaultTaskConfig = function () {
        var cwd = process.cwd();
        return {
    ...
    TemplatesTask.prototype.getModuleContainer = function () {
        if (!this.moduleContainer) {
            this.moduleContainer = new ModuleContainer_1.ModuleContainer();
        }
        return this.moduleContainer;
...
exports.TemplatesTask = TemplatesTask;
...
/******/ });
//# sourceMappingURL=TemplatesTask.map