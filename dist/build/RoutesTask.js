...
/******/ 	return __webpack_require__(__webpack_require__.s = "./exports/build/RoutesTask.ts");
/******/ })
/************************************************************************/
/******/ ({
...
Object.defineProperty(exports, "__esModule", { value: true });
var RoutesTask_1 = __webpack_require__(/*! ../../src/build/task/RoutesTask */ "./src/build/task/RoutesTask.ts");
module.exports = RoutesTask_1.RoutesTask;
...
var RoutesTask = /** @class */ (function (_super) {
    ...
    RoutesTask.prototype.exec = function () {
        ...
        var configFilePath = taskConfig.getByPath('configFilePath');
        var routesConfigKeyPath = taskConfig.getByPath('routesConfigKeyPath');
        // Read in config file
        var fileSystemModule = this.getModuleContainer().getFileSystemModule();
        var applicationConfigObject = null;
        var pathmap = null;
         ...
         */
        // Parse for Routes
        var routesConfig = applicationConfig.getByPath(routesConfigKeyPath);
        // If an instance of Config is returned, convert it to a native object
        if (routesConfig instanceof Config_1.Config) {
        ...
        var routesJsonString = JSON.stringify(routesConfig, null, 2);
        // Get the routes file output directory
        var outputDir = outputFilePath.replace(/[^/]*\.*$/, '');
        var autoloadModule = this.getModuleContainer().getAutoloadModule();
        // Add import statement block
        var importStatementBlock = autoloadModule
    ...
    RoutesTask.prototype.getDefaultTaskConfig = function () {
        var cwd = process.cwd();
        return {
    ...
    RoutesTask.prototype.getModuleContainer = function () {
        if (!this.moduleContainer) {
            this.moduleContainer = new ModuleContainer_1.ModuleContainer();
        }
        return this.moduleContainer;
...
/******/ });
//# sourceMappingURL=RoutesTask.map